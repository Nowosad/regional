...
test_that("reg_isolation modes are identical", {
  idx = c(304, 295, 308, 326, 331, 285)

  set.seed(32)
  reg_iso_memory = reg_isolation(vo[idx, ], ortho, sample_size = 0.5, optimize_for = "memory")
  set.seed(32)
  reg_iso_speed = reg_isolation(vo[idx, ], ortho, sample_size = 0.5, optimize_for = "speed")

  expect_equal(reg_iso_memory, reg_iso_speed)
})
